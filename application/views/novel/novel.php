...
<form action="<?=base_url()?>novel/newnovel" id="novel_list_form" method="post" enctype="multipart/form-data">
    <div>
        <input type="text" name="subject" id="subject" placeholder="소설 제목" autocomplete="off"> 
    </div>
    <hr>
        ...
        <div class="w50p">
            <div class="middler">
                ...
                <div class="form-floating h6vw">
                    <input type="text" class="form-control h6vw" id="tag" placeholder="name@example.com" name="tag">
...
<script type="text/javascript">
    ...
    img.addEventListener('change',(e)=>{
        ...
        if (file && file.type.startsWith('image/')) {
            ...
            $('#profile').attr('src', '/static/upload/default.png');
            return false;
        }
