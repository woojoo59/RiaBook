...
<div class="addnoticemain">
	<form id="noticeform" method="post" action="<?=base_url()?>other/editcomplaind?view=<?=$_GET['view']?>">
		<div class="title" id="titlediv" contenteditable><?=$subject?></div>
		<textarea id="summernote" name="content"><?=$content?></textarea>
		<input type="hidden" id="title" name="title">
	</form>
	<div class="btndiv">
		<button id="noticebtn" class="btn btn-outline-info">문의 하기</button>
	</div>
</div>
 <script>
