...
<div class="addnoticemain">
	<form id="noticeform" method="post" action="<?=base_url()?>other/addcomplaind">
		<div class="title statusplace" id="titlediv" contenteditable>문의할 제목을 입력해주세요.</div>
		<textarea id="summernote" name="content"></textarea>
		<input type="hidden" id="title" name="title">
	</form>
	<div class="btndiv">
		<button id="noticebtn" class="btn btn-outline-info">문의 사항 작성</button>
	</div>
</div>
 <script>
